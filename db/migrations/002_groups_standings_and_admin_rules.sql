...
insert into groups (code, name, sort_order) values
  ('A', 'Group A', 1),
  ('B', 'Group B', 2),
  ('C', 'Group C', 3),
  ('D', 'Group D', 4),
...
update teams set group_id = (select id from groups where code = 'J') where short_name = 'ARG';
update teams set group_id = (select id from groups where code = 'C') where short_name = 'BRA';
update teams set group_id = (select id from groups where code = 'I') where short_name = 'FRA';
update teams set group_id = (select id from groups where code = 'L') where short_name = 'ENG';
update teams set group_id = (select id from groups where code = 'E') where short_name = 'GER';
update teams set group_id = (select id from groups where code = 'H') where short_name = 'ESP';

insert into teams (name, short_name, flag_emoji, flag_url, group_id) values
  ('Mexico', 'MEX', null, null, (select id from groups where code = 'A')),
  ('South Africa', 'RSA', null, null, (select id from groups where code = 'A')),
  ('Korea Republic', 'KOR', null, null, (select id from groups where code = 'A')),
  ('Czechia', 'CZE', null, null, (select id from groups where code = 'A')),
  ('Canada', 'CAN', null, null, (select id from groups where code = 'B')),
  ('Bosnia and Herzegovina', 'BIH', null, null, (select id from groups where code = 'B')),
  ('Qatar', 'QAT', null, null, (select id from groups where code = 'B')),
  ('Switzerland', 'SUI', null, null, (select id from groups where code = 'B')),
  ('Morocco', 'MAR', null, null, (select id from groups where code = 'C')),
  ('Haiti', 'HAI', null, null, (select id from groups where code = 'C')),
  ('Scotland', 'SCO', null, null, (select id from groups where code = 'C')),
  ('United States', 'USA', null, null, (select id from groups where code = 'D')),
  ('Paraguay', 'PAR', null, null, (select id from groups where code = 'D')),
  ('Australia', 'AUS', null, null, (select id from groups where code = 'D')),
  ('Türkiye', 'TUR', null, null, (select id from groups where code = 'D')),
  ('Côte d''Ivoire', 'CIV', null, null, (select id from groups where code = 'E')),
  ('Ecuador', 'ECU', null, null, (select id from groups where code = 'E')),
  ('Curaçao', 'CUR', null, null, (select id from groups where code = 'E')),
  ('Netherlands', 'NED', null, null, (select id from groups where code = 'F')),
  ('Japan', 'JPN', null, null, (select id from groups where code = 'F')),
  ('Sweden', 'SWE', null, null, (select id from groups where code = 'F')),
  ('Tunisia', 'TUN', null, null, (select id from groups where code = 'F')),
  ('Iran', 'IRN', null, null, (select id from groups where code = 'G')),
  ('New Zealand', 'NZL', null, null, (select id from groups where code = 'G')),
  ('Belgium', 'BEL', null, null, (select id from groups where code = 'G')),
  ('Egypt', 'EGY', null, null, (select id from groups where code = 'G')),
  ('Saudi Arabia', 'KSA', null, null, (select id from groups where code = 'H')),
  ('Uruguay', 'URU', null, null, (select id from groups where code = 'H')),
  ('Cape Verde', 'CPV', null, null, (select id from groups where code = 'H')),
  ('Senegal', 'SEN', null, null, (select id from groups where code = 'I')),
  ('Iraq', 'IRQ', null, null, (select id from groups where code = 'I')),
  ('Norway', 'NOR', null, null, (select id from groups where code = 'I')),
  ('Algeria', 'ALG', null, null, (select id from groups where code = 'J')),
  ('Austria', 'AUT', null, null, (select id from groups where code = 'J')),
  ('Jordan', 'JOR', null, null, (select id from groups where code = 'J')),
  ('Portugal', 'POR', null, null, (select id from groups where code = 'K')),
  ('DR Congo', 'DRC', null, null, (select id from groups where code = 'K')),
  ('Uzbekistan', 'UZB', null, null, (select id from groups where code = 'K')),
  ('Colombia', 'COL', null, null, (select id from groups where code = 'K')),
  ('Ghana', 'GHA', null, null, (select id from groups where code = 'L')),
  ('Panama', 'PAN', null, null, (select id from groups where code = 'L')),
  ('Croatia', 'CRO', null, null, (select id from groups where code = 'L'))
...
update teams set group_id = (select id from groups where code = 'J') where name = 'Argentina';
update teams set group_id = (select id from groups where code = 'C') where name = 'Brazil';
update teams set group_id = (select id from groups where code = 'I') where name = 'France';
update teams set group_id = (select id from groups where code = 'L') where name = 'England';
update teams set group_id = (select id from groups where code = 'E') where name = 'Germany';
update teams set group_id = (select id from groups where code = 'H') where name = 'Spain';
